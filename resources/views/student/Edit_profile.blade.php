        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto  md:h-screen lg:py-0">
            <div
                ...
                @foreach ($data as $item)
                    <form class="space-y-4 md:space-y-6" action="{{ route('edit_student_profile', ['id' => $item->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="roll" id="roll" value="{{$item->roll}}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @error('roll')
                                <small class="text-danger text-yellow-400">{{ $message }}</small>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="father" id="father" value="{{$item->father}}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @error('father')
                                <small class="text-danger text-yellow-400">{{ $message }}</small>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="mother" id="mother" value="{{$item->mother}}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @error('mother')
                                <small class="text-danger text-yellow-400">{{ $message }}</small>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="phone" id="phone" value="{{$item->phone}}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @error('phone')
                                <small class="text-danger text-yellow-400">{{ $message }}</small>
                            @enderror
